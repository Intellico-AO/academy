...
import { ProgramFormData, ProgramCourse } from '../../../types';

export default function NovoProgramaPage() {
  const router = useRouter();
  const { adicionarPrograma, state } = useApp();
            ...
            <CardContent>
              ...
              {cursosDisponiveis.length > 0 ? (
                ...
                <div className="p-6 text-center bg-slate-50 rounded-lg border border-slate-200 border-dashed">
                  ...
                  <p className="text-slate-500 mb-2">Nenhum curso disponível</p>
                  <p className="text-sm text-slate-400">
                    Crie cursos primeiro para poder adicioná-los ao programa.
                  </p>
                </div>
              ) : (
                <div className="p-4 text-center bg-emerald-50 rounded-lg border border-emerald-200">
                  <p className="text-emerald-700">
                    Todos os cursos disponíveis já foram adicionados ao programa.
                  </p>
                </div>
              )}
            </CardContent>
