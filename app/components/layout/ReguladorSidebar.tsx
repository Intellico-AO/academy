...
const menuItems = [
  { href: '/regulador', label: 'Painel', icon: LayoutDashboard },
  { href: '/regulador/centros-formacao', label: 'Centros de Formação', icon: Building2 },
];
    ...
    >
      <div className="flex items-center gap-3 px-5 py-6 border-b border-slate-700/50 relative">
        ...
        {!isCollapsed && (
          <div className="flex flex-col">
            ...
            <span className="text-xs text-slate-400">Regulador</span>
          </div>
        )}
        <button
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        {menuItems.map((item) => {
          ...
          const isActive = item.href === '/regulador'
            ? pathname === '/regulador'
